INSERT INTO srbp_history.FUND_CASH_HISTORY SELECT
CAST(FUND_CASH_ACCT_SEQ	AS			NUMERIC),
...
FROM srbp_stage.FUND_CASH_STAGE

******************************************************************

INSERT INTO srbp_history.GHSS_ACCT_HISTORY SELECT
...
CTRY_CDE_FILTER				STRING,
ENTITY_CDE_FILTER			STRING
FROM srbp_stage.GHSS_ACCT_STAGE


*******************************************************************

INSERT  srbp_history.INVST_PLAN_HISTORY SELECT
CAST(INVST_PLAN_ARR_SEQ_NUM	AS	NUMERIC),
SEQ_DISP_NUM				STRING,
...
CAST(INVST_REG_AMT	AS		NUMERIC),
CCY_INVST_ACCUM_CDE			STRING,
CAST(INVST_ACCUM_AMT AS		NUMERIC),
CAST(CNTRB_SUCS_TTL_CNT	AS 	NUMERIC),
...
CTRY_CDE_FILTER				STRING,
ENTITY_CDE_FILTER			STRING
FROM srbp_stage.INVST_PLAN_STAGE

******************************************************
INSERT INTO srbp_history.INVST_PLAN_PROD_HISTORY SELECT
...
CTRY_CDE_FILTER				STRING,
ENTITY_CDE_FILTER			STRING
FROM srbp_stage.INVST_PLAN_PROD_STAGE

**********************************************************

INSERT INTO srbp_history.MIG_UINVST_ACCT_HISTORY SELECT
...
CTRY_CDE_FILTER				STRING,
ENTITY_CDE_FILTER			STRING
FROM srbp_stage.MIG_UINVST_ACCT_stage
